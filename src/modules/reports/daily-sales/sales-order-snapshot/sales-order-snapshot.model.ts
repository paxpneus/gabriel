  ...
  implements SalesOrderSnapshotAttributes
{
  ...
  public external_order_id?: string | null;
  public external_order_number?: string | null;
  public external_invoice_id?: string | null;
  ...
  public status_value?: string | null;
...
SalesOrderSnapshot.init(
  {
    ...
    external_order_id: { type: DataTypes.STRING(100), allowNull: true },
    external_order_number: { type: DataTypes.STRING(100), allowNull: true },
    external_invoice_id: { type: DataTypes.STRING(100), allowNull: true },
    ...
    status_id: { type: DataTypes.STRING(50), allowNull: true },
    status_name: { type: DataTypes.STRING(100), allowNull: true },
    status_value: { type: DataTypes.STRING(50), allowNull: true },
