  ...
  implements SalesOrderItemSnapshotAttributes
{
  ...
  public external_item_id?: string | null;
  public external_product_id?: string | null;
  public sku!: string;
...
const quantity = { type: DataTypes.DECIMAL(14, 4), defaultValue: 0 };
...
SalesOrderItemSnapshot.init(
  {
    ...
    external_item_id: { type: DataTypes.STRING(100), allowNull: true },
    external_product_id: { type: DataTypes.STRING(100), allowNull: true },
