...
- `collection-date.md` — origem do `collection_date` (dataPrevista da Bling ou `ML-SCRAPING`, fila separada que só roda no container `worker-scraping`, único com Playwright), bug de timezone UTC, `setDelayBasedOnDate`
